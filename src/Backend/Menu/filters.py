...
class MenuItemFilter(django_filters.FilterSet):
    ...
    price_min = django_filters.NumberFilter(field_name='price', lookup_expr='gte')  # Giá tối thiểu
    price_max = django_filters.NumberFilter(field_name='price', lookup_expr='lte')  # Giá tối đa
