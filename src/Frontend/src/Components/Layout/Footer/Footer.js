                            ...
                            <div className={style['col-lg-8']}>
                                <div className={style['footer-flex-box']}>
                                    <div className={style['footer-table-info']}>
                                        ...
                                        <ul>
                                            <li><i className={style['clock']}></i> Mon-Thurs : 9am - 22pm</li>
                                            <li><i className={style['clock']}></i> Fri-Sun : 11am - 22pm</li>
                                        </ul>
                                    </div>
                                    <div className={style['footer-menu'] + ' ' + style['food-nav-menu']}>
                    ...
                    <div className={style['row']}>
                        <div className={style['col-lg-12'] + ' ' + style['text-center']}>
                            <div className={style['copyright-text']}>
                                <p>Copyright &copy; 2024 <span className={style['name']}>Citrus Royale.</span> All Rights Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
