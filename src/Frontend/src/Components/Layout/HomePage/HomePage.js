        ...
        <section className={style['main-banner']}>
          <div className={style["js-parallax-scene"]}>
            <div className={style["banner-shape-1"]}>
              <img ref={(el) => (bgImg.current[0] = el)} data-depth="0.3" src="assets/images/berry.png" alt="" />
            </div>
            <div className={style["banner-shape-2"]}>
              <img ref={(el) => (bgImg.current[1] = el)} data-depth="0.25" src="assets/images/leaf.png" alt="" />
            </div>
          </div>
            ...
            <div className={style['col-lg-6']}>
              <div className={style['banner-text']}>
                ...
                <div className={style['banner-btn']}>
                  <button onClick={handleNavigate} className={style["cta-button"]}>Check Our Menu</button>
                </div>
              </div>
            </div>
            <div className={style['col-lg-6']}>
              <div className={style["banner-img-container"]}>
                <img className={style["banner-img"]} src="/assets/images/main-b.jpg" alt="Sushi" />
